...
console.log("subject="+subject +", fullName="+ fullName + ", nationality="+ nationality + ", profession="+profession +  ", birthYear="+birthYear );
...
// much like you did for the console logs and `fullName`
console.log("yearOfPublish="+yearOfPublish +", firstAlgorithm="+ firstAlgorithm + ", ageAtYearOfPublish="+ ageAtYearOfPublish );
...
console.log("nationality="+nationality +", cityLocation="+ cityLocation + ", countryLocation="+ countryLocation  + ", ageAtPassing="+ ageAtPassing);
//Topic: console.log()
...
console.log("statementTwo: " + statementOne );

//console log statementThree

console.log("statementThree: " + statementOne );
//console log statementFour
console.log("statementFour: " + statementOne );
